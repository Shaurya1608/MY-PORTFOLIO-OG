...
const corruptedPart = `                  <div
                    className="banner-three-wrap d-flex justify-content-between align-items-end position-relative z-1"
                  >
                          href="about.html"
                        >`;
...
content = content.replace(corruptedPart, correctReplacement);
